...
import { PenTool, CheckCircle, Download, ChevronDown, ChevronUp } from 'lucide-react';
...
export const DropboxSignature: React.FC<DropboxSignatureProps> = ({
  ...
  const handleTermsToggle = () => {
    ...
    // Reset scroll detection when collapsing
    if (termsExpanded) {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="bg-amber-50 border-2 border-amber-200 rounded-lg overflow-hidden">
          ...
          >
            <h3 className="font-semibold text-amber-900 text-lg">Terms and Conditions</h3>
            {termsExpanded ? (
          ...
          {termsExpanded && (
            <div className="px-6 pb-6">
              <div 
                className="text-sm text-gray-800 space-y-3 max-h-64 overflow-y-auto pr-2"
        ...
        {!termsExpanded && (
          <p className="text-xs text-gray-500 text-center">
            Please expand and review the terms and conditions above to continue
          </p>
        )}
        {termsExpanded && !hasScrolledToBottom && (
          <p className="text-xs text-gray-500 text-center">
